...
### **Версия 1.2.0** - Поддержка нескольких лицевых счетов 🏠
- ✅ **Множественные лицевые счета** - поддержка нескольких объектов в одной учетной записи
- ✅ **Отдельные устройства** - каждый лицевой счет как индивидуальное устройство в Home Assistant
- ✅ **Индивидуальные сенсоры** - все датчики работают для каждого счета отдельно
- ✅ **Улучшенная архитектура** - переработанная система получения данных
- ✅ **Обратная совместимость** - существующие настройки сохраняются
